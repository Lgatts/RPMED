 ...
 * @author Lucas
 */
public class SecretaryDetails extends javax.swing.JFrame {

    /**
     * Creates new form SecretaryDetails
     */
    public SecretaryDetails(ViewSecretaries viewSecretaries) {
        initComponents();
        
        Secretary secretary = viewSecretaries.getSelectedSecretary();
    ...
    private void initComponents() {
        ...
        jEditSecretaryName.setEditable(false);

        jEditSecretaryEmail.setEditable(false);

        jEditSecretaryFone.setEditable(false);
        try {
        ...
        jEditSecretaryCpf.setEditable(false);
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SecretaryDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SecretaryDetails(null).setVisible(true);
            }
        });
    }
